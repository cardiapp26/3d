...
const entry = (id, layer, color, system = null) => ({ id, layer, color, system });
export const atlasParts = {
  ...
  'Superior vena cava': entry('svc','vessels',0x62889c),
  'Inferior vena cava': entry('ivc','vessels',0x62889c),
  'Left superior pulmonary vein': entry('pv','vessels',0xb9827a),
  'Left inferior pulmonary vein': entry('pv','vessels',0xb9827a),
  'Right superior pulmonary vein': entry('pv','vessels',0xb9827a),
  'Right inferior pulmonary vein': entry('pv','vessels',0xb9827a),
  ...
  'Middle cardiac vein': entry('mcv','coronaries',0x679db2,'veins'),
  'Inferior vein of left ventricle': entry('cardiac-veins','coronaries',0x679db2,'veins'),
  "Inferior vein of left ventricle (//Posterior '')": entry('cardiac-veins','coronaries',0x679db2,'veins'),
  ...
  'Posterior leaflet of left atrioventricular valve': entry('mitral','valves',0xe2d5c4),
  'Septal leaflet of right atrioventricular valve': entry('tricuspid','valves',0xe2d5c4),
  'Inferior leaflet of right atrioventricular valve': entry('tricuspid','valves',0xe2d5c4),
